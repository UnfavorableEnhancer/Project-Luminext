...
func _change_style(style : int = 0, skin_data : SkinData = null) -> void:
	...
	$V/H/deletedblk.label_settings.font.base_font = font_settings[0]
	$V/H/deletedblk.label_settings.font_size = small_letter_settings[0]
	$V/H/deletedblk.label_settings.shadow_color = small_letter_settings[1]
	$V/H/deletedblk.label_settings.shadow_size = small_letter_settings[2]
	$V/H/deletedblk.label_settings.shadow_offset = small_letter_settings[3]
...
func _set_value(value : Variant, counter_name : String) -> void:
	match counter_name:
		...
		"deleted_blocks" : $V/H/deletedblk.text = str(value)
