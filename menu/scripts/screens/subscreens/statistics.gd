...
##-----------------------------------------------------------------------
## Loads and displays current profile stats
##-----------------------------------------------------------------------

var time_label : Label = null ## Total time label reference
...
func _ready() -> void:
	...
	for key : String in Player.savedata.stats:
		var label : Label = Label.new()
		label.label_settings = label_settings
		label.uppercase = true
		
		var value : int = Player.savedata.stats[key]
		
		match key:
			"total_time" : time_label = label
			"total_play_time" : label.text = tr("STATS_TOTAL_PLAY_TIME") + " : " + Main._to_time(value)
			...
			"top_time_spent_in_gameplay" : label.text = tr("STATS_GAMEPLAY_TIME") + " : " + Main._to_time(value)
			...
			"ta_total_time" : label.text = tr("STATS_TA_TOTAL_TIME") + " : " + Main._to_time(value)
			
			# Editors data
			"total_skin_editor_time" : label.text = tr("STATS_TOTAL_SE_TIME") + " : " + Main._to_time(value)
...
func _process(_delta: float) -> void:
	time_label.text = tr("STATS_TOTAL_TIME") + " : " + Main._to_time(Player.savedata.stats["total_time"])
